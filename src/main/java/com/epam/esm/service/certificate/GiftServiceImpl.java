...
public class GiftServiceImpl implements GiftService {
  ...
  public GiftCertificateDto update(long certificateId, GiftCertificateDto giftCertificateDto) {
    ...
    return mapper.toDto(
        optional.orElseThrow(() -> new EntityNotUpdatedException(CERTIFICATE, certificateId)));
  }
  ...
  public List<GiftCertificateDto> findAll(RequestParametersDto dto) {
    ...
    return mapper.toDtos(
        repository.findAllBySpecification(specifications, dto.getPage(), dto.getPageLimit()));
  }

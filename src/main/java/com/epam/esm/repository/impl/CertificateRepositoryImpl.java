...
@Repository
public class CertificateRepositoryImpl implements GiftRepository {
    ...
    @Autowired
    public CertificateRepositoryImpl(JdbcTemplate jdbcTemplate, RowMapper<GiftCertificate> giftMapper) {
